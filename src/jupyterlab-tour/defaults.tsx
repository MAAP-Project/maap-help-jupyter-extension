...
function addWelcomeTour(
  ...
  welcomeTour.addStep({
    ...
    content: __(
      'The following tour will point out some of the main UI components within JupyterLab.1'
    ),
    placement: 'center',
  ...
  welcomeTour.addStep({
    content: (
      <>
        <p>
          {__('Pause the tour by clicking anywhere outside of the tooltip.1')}
        </p>
...
export function addTours(
  ...
  addNotebookTour(manager, commands, shell as ILabShell);
}
